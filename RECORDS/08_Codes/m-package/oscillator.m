...
Vfiso::usage      = "Vfiso[m, \[Lambda],\[Alpha], x] returns the isospectral potential of Full line oscillator"
...
\[Psi]fiso::usage ="\[Psi]hiso[m, \[Lambda], \[Alpha], x] returns the isospectral wavefunction for index m, \
(\[Alpha]=0,m=0,2,4).";
\[Psi]hiso::usage ="\[Psi]hiso[m, \[Lambda], \[Alpha], x] returns the isospectral wavefunction for index m, \
(\[Alpha]=\[PlusMinus]1/2,m=0,1,2,3).";
...
Vfiso[0, \[Lambda]_, 0, x_] :=-2+x^2+(8 E^(-2 x^2))/(\[Pi] (1+2 \[Lambda]+Erf[x])^2)+(8 E^-x^2 x)/(Sqrt[\[Pi]] (1+2 \[Lambda]+Erf[x]));
Vfiso[2, \[Lambda]_, 0, x_] :=(4 (8-2 x^2+x^4)+4 E^x^2 Sqrt[\[Pi]] x (10-3 x^2+2 x^4) (1+2 \[Lambda]+Erf[x])+E^(2 x^2) \[Pi] (-10+9 x^2-4 x^4+4 x^6) (1+2 \[Lambda]+Erf[x])^2)/(2 x+E^x^2 Sqrt[\[Pi]] (1+2 x^2) (1+2 \[Lambda]+Erf[x]))^2;
Vfiso[4, \[Lambda]_, 0, x_] :=(4 (128-34 x^2+17 x^4+12 x^6+4 x^8)+4 E^x^2 Sqrt[\[Pi]] x (162-53 x^2+42 x^4+28 x^6+8 x^8) (1+2 \[Lambda]+Erf[x])+E^(2 x^2) \[Pi] (-162+153 x^2+8 x^4 (-9+13 x^2+8 x^4+2 x^6)) (1+2 \[Lambda]+Erf[x])^2)/(2 x (5+2 x^2)+E^x^2 Sqrt[\[Pi]] (3+4 x^2 (3+x^2)) (1+2 \[Lambda]+Erf[x]))^2;
...
\[Psi]fiso[0, \[Lambda]_, 0, x_] :=(2^(3/4) E^(-(x^2/2)) Sqrt[\[Lambda] (1+\[Lambda])])/(\[Pi]^(1/4) (1+2 \[Lambda]+Erf[x]));
\[Psi]fiso[2, \[Lambda]_, 0, x_] :=-((2 E^(x^2/2) (2 \[Pi])^(1/4) Sqrt[\[Lambda] (1+\[Lambda])])/(2 x+E^x^2 Sqrt[\[Pi]] (1+2 x^2) (1+2 \[Lambda])+E^x^2 Sqrt[\[Pi]] (1+2 x^2) Erf[x]));
\[Psi]fiso[4, \[Lambda]_, 0, x_] :=(4 Sqrt[3] E^(x^2/2) (2 \[Pi])^(1/4) Sqrt[\[Lambda] (1+\[Lambda])])/(2 x (5+2 x^2)+E^x^2 Sqrt[\[Pi]] (3+12 x^2+4 x^4) (1+2 \[Lambda])+E^x^2 Sqrt[\[Pi]] (3+12 x^2+4 x^4) Erf[x]);
